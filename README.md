...
3. Connect your ROSbot to the Husarnet network. Husarnet is already pre-installed so just run:
   ...
   > note that `rosbot2r` is a Husarnet hostname that is hardcoded in the [compose.pc.yaml](/rosbot-telepresence/tree/husarnet-dds/compose.pc.yaml) file. If you want a different hostname for your ROSbot remember to change it.
